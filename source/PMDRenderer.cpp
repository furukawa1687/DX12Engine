...
PMDRenderer::CreateGraphicsPipelineForPMD()
{
    ...
    auto             result    = D3DCompileFromFile(L"shader/BasicVertexShader.fx",
    ...
    result = D3DCompileFromFile(L"shader/BasicPixelShader.fx",
                                nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
                                "BasicPS", "ps_5_0",
                                D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
                                0, &psBlob, &errorBlob);
...
PMDRenderer::CreateRootSignature()
{
    ...
    com_ptr<ID3DBlob> rootSigBlob = nullptr;
    com_ptr<ID3DBlob> errorBlob   = nullptr;
